...
export default {
    ...
    created() {
      this.$axios.post('https://m.hua.com/home/GetProductListPrice?itemcodes=9012177,9010011,9010966,9012154,9010855,9012332,9012089,9012009,9012437,9012243,9012345,9010969').then(res => {
        console.log(res)
        var data=res.data.Datas.ProductPrices;
        this.list=data;
        });
  }
}
