  ...
  <div>
    <header class="headerbar">
      ...
      <div class="headerbar-content">
        ...
        <div class="headerbar-content-center">
          <a href="/home/searching" style="display:inline-block;width:100%;height:100%;">搜索鲜花、蛋糕、礼品</a>
        </div>
      </div>
    </header>
    ...
    <section class="catebox">
      ...
      <section class="catebox-details">
        <article id="hot" name="hot" class="catebox-details-mode active">
                            <header class="catebox-details-banner">
                                <a class="navigation" href="https://m.hua.com/xingjiabixianhua/">
                                    ...
                                    <nav class="catebox-details-list ">
                                                <div class="catebox-details-item">
                                                    <a href="/aiqingxianhua/" class="navigation">
                                                        <img class="catebox-details-item-pic" src="https://img02.hua.com/m/category/Classification/m_category_hot_Lover.png" alt="送恋人鲜花">
                                                        <p class="catebox-details-item-desc">送恋人鲜花</p>
                                                    </a>
                                                </div>
                                                <div class="catebox-details-item">
                                                    <a href="/songzhangbeixianhua/" class="navigation">
                                                        <img class="catebox-details-item-pic" src="https://img02.hua.com/m/category/Classification/m_category_hot_Elder.png" alt="送长辈鲜花">
                                                ...
                                                <div class="catebox-details-item">
                                                    <a href="/hezhuanghua/" class="navigation">
                                                        <img class="catebox-details-item-pic" src="https://img02.hua.com/m/category/Classification/m_category_hot_Boxedflowers.png" alt="礼盒鲜花">
                                                        <p class="catebox-details-item-desc">礼盒鲜花</p>
                                                    </a>
                                                </div>
                                                <div class="catebox-details-item">
                                                ...
                                                <div class="catebox-details-item">
                                                    <a href="/cake/" class="navigation">
                                                        <img class="catebox-details-item-pic" src="https://img02.hua.com/m/category/Classification/m_category_hot_Cake.png" alt="蛋糕">
                                                ...
                                                <div class="catebox-details-item">
                                                    <a href="/gansodangao/" class="navigation">
                                                        ...
                                                        <p class="catebox-details-item-desc">元祖蛋糕</p>
                                                    </a>
                                                </div>
                                                <div class="catebox-details-item">
                                                ...
                                                <div class="catebox-details-item">
                                                    <a href="/gifts/shoushi/" class="navigation">
                                                        ...
                                                        <p class="catebox-details-item-desc">首饰</p>
                                                    </a>
                                                </div>
                                                <div class="catebox-details-item">
                                                    <a href="/qiaokeli/" class="navigation">
                                                        ...
                                                        <p class="catebox-details-item-desc">巧罗巧克力</p>
                                                    </a>
                                                </div>
                                                <div class="catebox-details-item">
                                                    <a href="/gifts/" class="navigation">
                                                        ...
                                                        <p class="catebox-details-item-desc">创意礼品</p>
                                                    </a>
                                                </div>
                                                <div class="catebox-details-item">
...
<script>
import saside from "../views/saside";
export default {
  components: {
    saside
  }
...
.headerbar-content-center input {
  color: #232628;
  width: 100%;
  height: 2.57142857rem;
  background-color: transparent;
